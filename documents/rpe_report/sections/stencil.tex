...
Stencils funtions derived from finite difference methods.
...
Mechanical engineering \cite{Rappaz2003}

Meteorology \cite{Singh2023SPARTA, Avissar1989Weather, Kalnay1990Weather}

Image Processing \cite{}

Cellular Automata are an interesting subset of stencil computations, with particular applicability to modelling natural systems \cite{Mendicino2015Eco, Caux2010HashLife, Sitko2016Cellular, Wolfram1984Cellular, Kyparissas2020Cellular}.

Complexity of implementing stencil computations 
has led to a proliferation of specialized stencil compilers 
\cite{Bauer2019PhaseField, Bauer2021lbmpy, Ahmad2022, Tang2011Pochoir}.
